...
+ I like nesting headlines and I want LaTeX to respect that when I use it to pummel an org document into a the shape of a pdf.
...
*** All Childframes All the Time
+ The ~mini-frame~ package pops things out to a nice looking floating childframe that would have normally been in the minibuffer. I'm playing around with this and ~vertico-posframe~.
